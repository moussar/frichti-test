...
describe('Helpers - Browser/Cookies', () => {
  ...
  describe('createCookie helper', () => {
    ...
    it('should create multiples cookies', () => {
      ...
      expect(document.cookie)
        .toEqual('cookie=chocolate; ice-cream=vanilla');
    });
  });
  ...
  describe('readCookie helper', () => {
    it('should read a cookie', () => {
      ...
      expect(readCookie('cookie'))
        .toEqual('chocolate');
      expect(readCookie('ice-cream'))
        .toEqual('vanilla');
    });

    it('should return null if no cookie', () => {
      expect(readCookie('cheese-cake'))
        .toBe(null);
    });
  });
